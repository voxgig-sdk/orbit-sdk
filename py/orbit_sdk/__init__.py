...
from orbit_sdk.utility import register

# Load features
from orbit_sdk.feature.base_feature import OrbitBaseFeature
from orbit_sdk.features import _has_feature, _make_feature
...
class OrbitSDK:
    ...
    def get_utility(self):
        return OrbitUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OrbitSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "OrbitSDK":
        if sdkopts is None:
            sdkopts = {}
