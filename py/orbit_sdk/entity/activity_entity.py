...
from orbit_sdk.orbit_types import (
    Activity,
    ActivityLoadMatch,
    ActivityCreateData,
    ActivityUpdateData,
...
class ActivityEntity:
    ...
    def create(self, reqdata: ActivityCreateData, ctrl=None) -> Activity:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: ActivityUpdateData, ctrl=None) -> Activity:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
    ...
    def remove(self, reqmatch=None, ctrl=None) -> Activity:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key removes with no
        # match. Treat None as an empty match so client.Activity().remove()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
