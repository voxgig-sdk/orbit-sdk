...
from orbit_sdk.core.control import OrbitControl
...
from orbit_sdk.core.helpers import get_ctx_prop, to_map
...
class OrbitContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, OrbitResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return OrbitError(code, msg, self)
