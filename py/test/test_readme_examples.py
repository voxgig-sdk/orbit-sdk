# Orbit SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OrbitSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OrbitSDK(...) and OrbitSDK.test(...) become
#      OrbitSDK.test({"entity": {...}}) seeding one mock record (id "test01")
