...
---@param reqdata ActivityCreateData
---@param ctrl? table
---@return Activity
---@return string? err
function ActivityEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ActivityUpdateData
---@param ctrl? table
---@return Activity
---@return string? err
function ActivityEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ActivityRemoveMatch
---@param ctrl? table
---@return Activity
---@return string? err
function ActivityEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
