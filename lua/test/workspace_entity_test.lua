...
describe("WorkspaceEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set ORBIT_TEST_WORKSPACE_ENTID JSON to run live")
      return
    end
...
function workspace_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("ORBIT_TEST_WORKSPACE_ENTID")
