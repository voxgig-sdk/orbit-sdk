...
describe("ActivityTypeDirect", function()
  it("should direct-load-activity_type", function()
    local setup = activity_type_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-activity_type", setup.live and "live" or "unit")
