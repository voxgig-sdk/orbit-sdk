...
describe("ReportDirect", function()
  it("should direct-load-report", function()
    local setup = report_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-report", setup.live and "live" or "unit")
...
function report_direct_setup(mockres)
