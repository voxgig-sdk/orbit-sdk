...
OrbitSDK._make_feature = _make_feature


function OrbitSDK.new(options)
  local self = setmetatable({}, OrbitSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function OrbitSDK:get_utility()
  return Utility.copy(self._utility)
end


function OrbitSDK:get_root_ctx()
  return self._rootctx
end


function OrbitSDK:prepare(fetchargs)
...
function OrbitSDK:direct(fetchargs)
...
-- by passing it.
function OrbitSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function OrbitSDK:graphql(query, variables, ctrl)
...
function OrbitSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = OrbitSDK.new(sdkopts)
  sdk.mode = "test"
