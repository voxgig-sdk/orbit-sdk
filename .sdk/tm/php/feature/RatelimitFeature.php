...
class OrbitRatelimitFeature extends OrbitBaseFeature
{
    ...
    private function _acquire(OrbitContext $ctx): void
    {
    ...
    private function _track(OrbitContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
