...
class OrbitTimeoutFeature extends OrbitBaseFeature
{
    ...
    private function _with_timeout(OrbitContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OrbitContext $_ctx, float $ms): void
    {
        $client = $this->client;
