...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = OrbitOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(OrbitOmni::structfix($now, Struct::undef()))
                        !== json_encode(OrbitOmni::structfix($val, Struct::undef()))) {
