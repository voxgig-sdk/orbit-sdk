...
class OrbitFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OrbitSDK/1.0)';
    ...
    public static function call(OrbitContext $ctx, string $fullurl, array $fetchdef): array
    {
