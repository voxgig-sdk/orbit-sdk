...
class OrbitTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OrbitTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = OrbitTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = OrbitTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
