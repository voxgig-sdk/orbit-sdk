...
|---|---|---|
| `js/` | @voxgig-sdk/orbit-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/orbit | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/orbit-js \
      --repository voxgig-sdk/orbit-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/orbit-js` shows it, and
`npm trust revoke @voxgig-sdk/orbit-js --id=<id>` removes it.
