...
// Orbit SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class OrbitMakeRequest
{
    public static function call(OrbitContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new OrbitResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new OrbitResponse($fetched);
        } else {
