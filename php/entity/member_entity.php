...
class MemberEntity
{
     ...
     *
     * @param MemberLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MemberLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Member|array The loaded Member as an assoc-array at the
     ...
     *   the SDK boundary; throws OrbitError on failure (item-5 convention).
     */
     ...
     * Create a new Member.
     *
     * @param MemberCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MemberCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Member|array The created Member as an assoc-array at the
     *   SDK boundary; throws OrbitError on failure (item-5 convention).
     */
