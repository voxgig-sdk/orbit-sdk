...
class ActivityTypeEntity
{
    ...
    /**
     * Load a single ActivityType.
     *
     * @param ActivityTypeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ActivityTypeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ActivityType|array The loaded ActivityType as an assoc-array at the
