...
// Orbit SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OrbitSDK::test)
...
{
    private const SDK_CLASS = 'OrbitSDK';
    ...
    private const SDK_BASE = 'orbit_sdk';
