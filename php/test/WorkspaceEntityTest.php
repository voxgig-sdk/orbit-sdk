...
class WorkspaceEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set ORBIT_TEST_WORKSPACE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function workspace_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("ORBIT_TEST_WORKSPACE_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["ORBIT_TEST_WORKSPACE_ENTID"]);
