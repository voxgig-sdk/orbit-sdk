...
class ReportDirectTest extends TestCase
{
    public function test_direct_load_report(): void
    {
        $setup = report_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-report", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
