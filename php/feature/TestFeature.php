...
// Orbit SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class OrbitTestFeature extends OrbitBaseFeature
{
    ...
    public function init(OrbitContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (OrbitContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (OrbitContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(OrbitContext $ctx, $op, $args): array
    {
