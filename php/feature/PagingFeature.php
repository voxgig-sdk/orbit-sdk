...
class OrbitPagingFeature extends OrbitBaseFeature
{
    ...
    private function _graphql_pre_request(OrbitContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(OrbitContext $ctx): bool
    {
