...
func registerTools(server *mcp.Server, client *sdk.OrbitSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "orbit_list",
		Description: "List records from Orbit. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "orbit_load",
		Description: "Load a single record from Orbit. " +
...
func runOp(client *sdk.OrbitSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
