...
describe('ActivityTypeEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    const activity_type_ref01_match_dt0 = {}
    const activity_type_ref01_data_dt0 = (await activity_type_ref01_ent.load(activity_type_ref01_match_dt0)).data()
    assert(null != activity_type_ref01_data_dt0)
