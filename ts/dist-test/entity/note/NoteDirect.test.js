...
(0, node_test_1.describe)('NoteDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-note', async (t) => {
        ...
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-note', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["member_slug01", "workspace_slug01"]))
            return;
        ...
        if (setup.live) {
            ...
            params.member_slug = 'direct01';
            params.workspace_slug = 'direct02';
        }
        const result = await client.direct({
            path: '{workspace_slug}/members/{member_slug}/notes',
            method: 'GET',
            params,
            query,
        });
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ORBIT_TEST_NOTE_ENTID'];
