...
function basicSetup(extra) {
    ...
    let idmap = transform(['note01', 'note02', 'note03', 'member01', 'member02', 'member03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
