...
(0, node_test_1.describe)('MemberEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != member_ref01_data.id);
        // LIST
        ...
        (0, node_assert_1.default)(!isempty(select(member_ref01_list, { id: member_ref01_data.id })));
        // UPDATE
        ...
        (0, node_assert_1.default)(member_ref01_resdata_up0[member_ref01_markdef_up0.name] === member_ref01_markdef_up0.value);
        // LOAD
        ...
        // REMOVE
        const member_ref01_match_rm0 = { id: member_ref01_data.id };
        ...
        (0, node_assert_1.default)(isempty(select(member_ref01_list_rt0, { id: member_ref01_data.id })));
    });
});
