...
(0, node_test_1.describe)('ReportDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-report', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-report', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.ORBIT_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    const calls = [];
    const env = (0, utility_1.envOverride)({
        'ORBIT_TEST_REPORT_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.OrbitSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.ORBIT_APIKEY,
        }));
        let idmap = env['ORBIT_TEST_REPORT_ENTID'];
...
//# sourceMappingURL=ReportDirect.test.js.map