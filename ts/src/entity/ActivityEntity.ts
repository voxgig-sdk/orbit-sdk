...
class ActivityEntity extends OrbitEntityBase<Activity> {
  ...
  async create(this: any, reqdata?: ActivityCreateData, ctrl?: Control): Promise<ActivityEntity> {
  ...
  async update(this: any, reqdata?: ActivityUpdateData, ctrl?: Control): Promise<ActivityEntity> {
  ...
  async remove(
    this: any, reqmatch?: ActivityRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<ActivityEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
