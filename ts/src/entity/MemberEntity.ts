...
class MemberEntity extends OrbitEntityBase<Member> {
  ...
  async load(this: any, reqmatch?: MemberLoadMatch, ctrl?: Control): Promise<MemberEntity> {
  ...
  async create(this: any, reqdata?: MemberCreateData, ctrl?: Control): Promise<MemberEntity> {
