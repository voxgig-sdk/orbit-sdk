...
func TestWorkspaceEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set ORBIT_TEST_WORKSPACE_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func workspaceBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("ORBIT_TEST_WORKSPACE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["ORBIT_TEST_WORKSPACE_ENTID"])
