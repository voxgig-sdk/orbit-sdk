...
func (sdk *OrbitSDK) OptionsMap() map[string]any {
...
func (sdk *OrbitSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *OrbitSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *OrbitSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OrbitSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *OrbitSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *OrbitSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("OrbitSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *OrbitSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OrbitSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("OrbitSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
