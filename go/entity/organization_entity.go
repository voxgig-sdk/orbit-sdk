...
func NewOrganizationEntity(client *core.OrbitSDK, entopts map[string]any) *OrganizationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OrganizationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
