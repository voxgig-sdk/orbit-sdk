...
func NewMemberEntity(client *core.OrbitSDK, entopts map[string]any) *MemberEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MemberEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MemberLoadMatch and returns an Member. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MemberEntity) LoadTyped(reqmatch MemberLoadMatch, ctrl map[string]any) (Member, error) {
...
func (e *MemberEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// MemberCreateData and returns an Member. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *MemberEntity) CreateTyped(reqdata MemberCreateData, ctrl map[string]any) (Member, error) {
