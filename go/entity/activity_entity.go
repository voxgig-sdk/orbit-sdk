...
func NewActivityEntity(client *core.OrbitSDK, entopts map[string]any) *ActivityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ActivityEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// ActivityCreateData and returns an Activity. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ActivityEntity) CreateTyped(reqdata ActivityCreateData, ctrl map[string]any) (Activity, error) {
...
func (e *ActivityEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// ActivityUpdateData and returns an Activity. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *ActivityEntity) UpdateTyped(reqdata ActivityUpdateData, ctrl map[string]any) (Activity, error) {
...
func (e *ActivityEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// ActivityRemoveMatch and returns an Activity. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ActivityEntity) RemoveTyped(reqmatch ActivityRemoveMatch, ctrl map[string]any) (Activity, error) {
