...
func NewReportEntity(client *core.OrbitSDK, entopts map[string]any) *ReportEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReportEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ReportLoadMatch and returns an Report. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ReportEntity) LoadTyped(reqmatch ReportLoadMatch, ctrl map[string]any) (Report, error) {
...
func (e *ReportEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
