...
func NewActivityTypeEntity(client *core.OrbitSDK, entopts map[string]any) *ActivityTypeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ActivityTypeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ActivityTypeLoadMatch and returns an ActivityType. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ActivityTypeEntity) LoadTyped(reqmatch ActivityTypeLoadMatch, ctrl map[string]any) (ActivityType, error) {
...
func (e *ActivityTypeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ActivityTypeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ActivityTypeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ActivityTypeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
