...
func NewWorkspaceEntity(client *core.OrbitSDK, entopts map[string]any) *WorkspaceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WorkspaceEntity) List(_ map[string]any, _ map[string]any) (any, error) {
